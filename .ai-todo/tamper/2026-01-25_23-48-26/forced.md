...
- [ ] **#212** Clean up .cursor rules for MCP-first workflow `#maintenance`
...
- [ ] **#210** Implement TODO.md tamper detection and warnings `#feature` `#integrity` `#security`
  ...
  - [x] **#210.5** Create unit and integration tests for tamper detection `#test` `#validation`
  - [x] **#210.4** Implement tamper detection in FileOps and CLI commands `#code` `#implementation`
  - [x] **#210.3** Design tamper detection solution (detection mechanism, warning system, recovery options) `#architecture` `#design`
