...
- [ ] **#125** Overhaul bug reporting feature: eliminate prompts and improve formatting `#bug` `#feature`
  ...
  - [ ] **#125.13** Update bug reporting design document with new implementation details `#docs`
  ...
  - [ ] **#125.11** Update cursor rules to reflect new agent-friendly bug reporting workflow `#docs`
  ...
  - [ ] **#125.10** Add intelligent error categorization and suggested labels `#feature`
  ...
  - [ ] **#125.9** Enhance context auto-collection: add git status, recent commands, TODO.md state `#code`
  ...
  - [ ] **#125.8** Remove prompts from suggest_bug_report() - make fully automated for AI agents `#code`
  ...
  - [ ] **#125.7** Rewrite generate_bug_report() to use GitHub callout blocks and better markdown structure `#code`
  ...
  - [ ] **#125.6** Create GitHub issue template for bug reports (.github/ISSUE_TEMPLATE/bug_report.yml) `#feature`
...
**Last Updated:** Wed Nov 12 00:43:18 CET 2025
