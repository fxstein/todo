...
def add_subtask_command(parent_id: str, description: str, tags: List[str], todo_path: str = "TODO.md"):
    """Add a subtask."""
...
def list_command(status: str = None, tag: str = None, todo_path: str = "TODO.md"):
    """List tasks."""
    manager = get_manager(todo_path)
